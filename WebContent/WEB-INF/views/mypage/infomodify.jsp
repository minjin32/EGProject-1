     ...
     <div class="row">
		...
		<div class="col p-5">
			<div style="height:900px;">
				<div style="height:10%; width:100%;" ><h1>정보 수정</h1></div>
					<div style="height:40%; width:100% ;padding:50px; backgorund-color:red">
					
						<div class="input-group mb-3" style="width:350px">
  						<span class="input-group-text" id="inputGroup-sizing-default" style="width: 130px; background-color: #D1E9CA">이름</span>
  						<input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" style="width:50px">
						</div>
						
						<div class="input-group mb-3" style="width:350px">
  						<span class="input-group-text" id="inputGroup-sizing-defaultl" style="width: 130px; background-color: #D1E9CA" >닉네임</span>
  						<input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" style="width:100px">
						</div>
						
						<div class="input-group mb-3" style="width:350px">
  						<span class="input-group-text" id="inputGroup-sizing-default"  style="width: 130px;background-color: #D1E9CA">비밀번호</span>
  						<input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" style="width:100px">
						</div>
						
						<div class="input-group mb-3" style="width:350px">
  						<span class="input-group-text" id="inputGroup-sizing-default"  style="width: 130px;background-color: #D1E9CA">비밀번호 확인</span>
  						<input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" style="width:100px">
						</div>
