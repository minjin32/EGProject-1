	...
	<div class="container-lg">
		<div class="row">
			...
			<div class="col-lg-9 p-5">
				<div>
					<h2 class="pb-2">공지사항 수정</h2>
					<form class="p-4" action="/eco/notice/update" method="post"
						...
						<div class="gap-2 d-md-flex justify-content-md-end">
							...
							<a href="/eco/notice/list"><button type="submit" class="btn btn-primary">수정완료</button></a>
						</div>
					</form>
				</div>
			</div>
